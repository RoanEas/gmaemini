...
if (!$ext) $ext = 'jpg';
$filename = 'bingo_' . time() . '_' . rand(1000,9999) . '.' . strtolower($ext);

// The root of project is 2 levels up
$targetDir = dirname(__DIR__, 2) . '/assets/bingo/';
if (!is_dir($targetDir)) {
...
if (move_uploaded_file($file['tmp_name'], $targetPath)) {
    ...
    $relativePath = 'assets/bingo/' . $filename;
